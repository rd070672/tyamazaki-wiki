# ギブス自由エネルギーで合金を設計する：相安定性・相図・CALPHAD・計算の統合
...
### 5.2 過剰ギブスエネルギーの典型（Redlich-Kister型）
二元溶体相の過剰項は、例えば
$$
...
## 6. 計算科学との統合：第一原理・統計熱力学を$G$へ接続する
