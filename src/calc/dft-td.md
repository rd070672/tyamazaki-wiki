# 時間依存密度汎関数理論（TDDFT）：定式化・線形応答・実時間発展と励起現象
...
## 2. 基礎定理：密度 ↔ ポテンシャルの一意性

### 2.1 Runge–Gross定理（時間依存版の土台）
...
## 3. 時間依存Kohn–Sham方程式：計算で実際に解いている式
...
## 5. 実時間TDDFT：パルス・強励起・非線形応答へ

### 5.1 基本手順（δキックとフーリエ変換）
