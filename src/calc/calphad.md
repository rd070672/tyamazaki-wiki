# CALPHAD法（計算熱力学）による状態図・相平衡予測：ギブスエネルギーから多元系設計へ
...
## 1. CALPHADの中核：相平衡はギブスエネルギー最小化で決まる
...
## 4. Assessment（熱力学評価）の実務フロー
CALPHADの品質はassessmentに依存する。最小構成の手順は次である。
