# Allen–Cahn 方程式に基づく金属組織シミュレーション：粒界移動・相変態・規則化をつなぐフェーズフィールド
...
## 2. 基礎式：自由エネルギーの勾配流としての Allen–Cahn
