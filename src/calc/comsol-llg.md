# COMSOL による LLG 方程式とマルチフィジックス連成（電磁場・弾性場）
...
### 5.4 電磁場–LLG 連成（AC/DC 等）を組むポイント
...
### 5.5 弾性場–LLG 連成（Solid Mechanics）を組むポイント
