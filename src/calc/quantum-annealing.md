# 量子アニーリング：横磁場イジング模型にもとづく最適化と物性サンプリング
...
## 6. スケジュール設計の拡張：pause、reverse annealing、局所探索
