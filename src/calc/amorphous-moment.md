# アモルファスにおける局所磁気モーメント：定義・観測・計算・相関解析の体系
...
## 2. なぜアモルファスで局所モーメントが分布するのか

### 2.1 局所電子状態の多様性：Stoner型の直感
遍歴磁性の最小直感はStoner条件である。
...
## 3. 実験で局所モーメントを見る：何が何に強いか

### 3.1 メスバウアー分光：Fe系での局所情報の王道
...
## 4. 計算で局所モーメントを求める：標準ワークフロー

### 4.1 構造サンプルを作る（統計性が第一）
