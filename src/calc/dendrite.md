# デンドライト成長のフェーズフィールドシミュレーション：異方性 Allen–Cahn 方程式と熱拡散連成の標準モデル
...
## 1. ねらい
デンドライト成長を再現するための最小構成は次の2本立てである。
...
## 2. 自由エネルギーと Allen–Cahn 方程式（異方性つき）
### 2.1 自由エネルギーの典型形
固液の二相系に対して、汎関数を
$$
