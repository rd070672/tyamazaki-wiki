...
### 3.2 非アフィン変位と $D^2_{min}$（局所塑性の指標）
外部変形に対して、原子近傍がアフィン変形からどれだけ外れたかを定量化する。
...
## 7. 局所磁気物性：局所モーメント・相互作用の分布として捉える
...
## 8. 局所物性を「相関」として抽出する統計手法

### 8.1 条件付き平均（局所環境でビン分け）
