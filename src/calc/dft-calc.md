# 第一原理計算を支える数値解法：SCF収束・固有値解法・k点積分の要点
...
## 4. SCF収束：固定点反復を「収束する写像」に作り替える
### 4.1 固定点反復はそのままだと揺れやすい
最も単純な更新は線形混合である。
$$
...
### 4.2 混合法：Pulay/DIIS、Anderson、Broyden
SCFは非線形方程式
$$
