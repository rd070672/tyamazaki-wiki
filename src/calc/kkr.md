...
### 2.2 サイト間伝播：構造定数（自由空間グリーン関数の結晶版）
...
### 2.3 散乱経路演算子（scattering path operator）
多重散乱の足し上げは、典型的に
$$
