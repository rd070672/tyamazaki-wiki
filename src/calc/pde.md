...
#### 参考ドキュメント
- [[PDF]常微分方程式 講義ノート - Kyoto U](https://www2.yukawa.kyoto-u.ac.jp/~norihiro.tanahashi/pdf/ODE/note_ODE.pdf)
- [Modeling with PDEs: Global ODEs and DAEs Interface
](https://www.comsol.jp/support/learning-center/article/Modeling-with-PDEs-Global-ODEs-and-DAEs-Interface-57241/142)
...
- 連続体力学・熱伝導・電磁気学・流体・量子力学など、ほぼ全ての場の方程式が PDE で記述される。
...
- 弱形式（weak / variational form）：
  - 試験関数 v をかけて領域で積分し、部分積分を行う：
    $$
      ...
      + \text{境界項}
    $$
- FEM のような変分法ベースの数値手法では、弱形式が出発点になる。
...
- PDE は多くの場合、解析解が得られないため、数値解法が主役となる。
- 主な離散化手法：
  - 有限差分法 (FDM)：格子点上の差分近似。
