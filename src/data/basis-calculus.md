# 機械学習のための微積分：勾配・連鎖律・最適化・期待値までの基礎整理
...
## 8. 自動微分（Automatic Differentiation）：プログラムとしての連鎖律
...
### 8.3 計算グラフ（computation graph）の意味
